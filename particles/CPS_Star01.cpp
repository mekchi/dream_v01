...
bool CPS_Star01::Init(void* Property)
{
...
void CPS_Star01::Reset(void *Property)
{
    
}

bool CPS_Star01::Update(float DeltaTime)
{
...
IParticleSystem* CPS_Star01::Create()
{
    return new CPS_Star01();
}

//void CPS_Star01::Destroy(IParticleSystem *ParticleSystem)
//{
